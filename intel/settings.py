...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Aunice Topup GH",
    "site_header": "Aunice Topup GH",
    # "site_logo": "img/site/bestPay Logo.png",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Aunice Topup GH",
    "copyright": "Aunice Topup GH",
    # "login_logo": "img/site/bp.png",
    "welcome_sign": "Welcome to the Aunice Topup GH Admin",
